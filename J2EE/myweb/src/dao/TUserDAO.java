 ...
 */
@Transactional
public class TUserDAO implements IUserDAO {
	...
	/* (non-Javadoc)
	 * @see dao.IUserDAO#save(entity.TUser)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dao.IUserDAO#delete(entity.TUser)
	 */
	@Override
	...
	public TUser findById(java.lang.Integer id) {
		...
		try {
			TUser instance = (TUser) getCurrentSession()
					.get("entity.TUser", id);
			return instance;
		} catch (RuntimeException re) {
	...
	/* (non-Javadoc)
	 * @see dao.IUserDAO#findByExample(entity.TUser)
	 */
	@Override
	public List findByExample(TUser instance) {
		log.debug("finding TUser instance by example");
		try {
			List results = getCurrentSession().createCriteria("entity.TUser")
	...
	/* (non-Javadoc)
	 * @see dao.IUserDAO#merge(entity.TUser)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dao.IUserDAO#attachDirty(entity.TUser)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dao.IUserDAO#attachClean(entity.TUser)
	 */
	@Override
