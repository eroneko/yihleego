...
ig.module("game.levels.main").requires("impact.image").defines(function(){LevelMain={entities:[],layer:[{name:"background",width:60,height:50,linkWithCollision:!1,visible:!0,tilesetName:"media/tiles.png",repeat:!1,preRender:!0,distance:"1",tilesize:24,foreground:!1,data:[]},{name:"map",width:60,height:50,linkWithCollision:!1,visible:!0,tilesetName:"media/tiles.png",repeat:!1,preRender:!1,distance:"1",tilesize:24,foreground:!1,data:[]},{name:"collision",width:60,height:50,linkWithCollision:!1,visible:!0,
tilesetName:"",repeat:!1,preRender:!1,distance:1,tilesize:24,foreground:!1,data:[]}]};LevelMainResources=[new ig.Image("media/tiles.png"),new ig.Image("media/tiles.png")]});ig.baked=!0;
ig.module("game.entities.player").requires("impact.entity").defines(function(){EntityPlayer=ig.Entity.extend({size:{x:24,y:24},collides:ig.Entity.COLLIDES.ACTIVE,animSheet:new ig.AnimationSheet("media/players.png",24,24),targetPos:{x:0,y:0},step:12,speed:{x:0,y:0},inputTimer:void 0,isHolding:!1,isWaiting:!0,isMoving:!1,points:[],init:function(a,b,c){this.parent(a,b,c);this.initPoints();this.vel.x=0;this.vel.y=0;this.addAnim("idle",.5,[0,1]);this.inputTimer=new ig.Timer(.2)},faceFlip:function(a){this.currentAnim.flip.x=
